...
activities = {
    ...
    "Basketball Club": {
        "description": "Pickup games, drills, and skill development",
    ...
    "Drama Club": {
        "description": "Performing arts, stagecraft, and school productions",
    ...
    "Robotics Club": {
        "description": "Design and build robots for local and regional competitions",
